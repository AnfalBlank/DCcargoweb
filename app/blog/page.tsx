...
const blogFAQs = [
  { q: "Bagaimana cara mengemas barang fragile agar aman dikirim?", a: "Gunakan bubble wrap minimal 3 lapis, isi ruang kosong dengan styrofoam atau kertas koran, gunakan double box untuk barang sangat rapuh, dan beri label 'FRAGILE' yang jelas. DC Cargo juga menyediakan layanan pengemasan profesional.", waText: "Halo DC Solution, saya ingin kirim barang fragile. Apakah ada layanan pengemasan khusus dan berapa biayanya?" },
